...
class TestParser(unittest.TestCase):
  ...
  def test_insuranceCostCalculator(self):
      ...
      req_output={'statusCode': 200, 'body': '{"Date": "03/31/2018","Buildings": [{"name": "Buildings","suggested_insurance_cost": 127356031.75}  ],  "Plant and Machinery": [{"name": "Plant and Machinery","suggested_insurance_cost": 330870436.51}],"Office Equipments": [{"name": "Electric installation and equipment","suggested_insurance_cost": 673214.29},{"name": "Computers and data processing units","suggested_insurance_cost": 10652896.83},{"name": "Office equipment","suggested_insurance_cost": 3981746.03}],"Furniture & Fixtures": [{"name": "Furniture and Fittings","suggested_insurance_cost": 3345357.14}],"amount_unit": "lakhs"}'}

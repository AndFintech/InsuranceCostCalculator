...
class TestParser(unittest.TestCase):
  ...
  def test_insuranceCostCalculator(self):
      ...
      req_output={'statusCode': 200, 'body': '{"Date": "03/31/2018", "Buildings": {"name": "Buildings ", "suggested_insurance_cost": 1273.56}, "Plant and Machinery": {"name": "Plant and Machinery ", "suggested_insurance_cost": 3308.7}, "Office Equipments": {"name": "Office equipment ", "suggested_insurance_cost": 39.82}, "Furniture & Fixtures": {"name": "Furniture and Fittings ", "suggested_insurance_cost": 33.45}, "amount_unit": "lakhs"}'}
